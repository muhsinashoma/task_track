...
class _KanbanSetStatePageState extends State<KanbanSetStatePage>
  ...
  getColumnData() async {
    try {
      final dio = Dio();
      var response =
          await dio.get("http://192.168.33.69/API/get_column_data_kanban.php");
  ...
  getTaskData() async {
    try {
      final dio = Dio();
      var response =
          await dio.get("http://192.168.33.69/API/get_task_data_kanban.php");
      // print(response);
  ...
  Future<void> deleteItem(int columnIndex, KTask task) async {
    ...
    final dio = Dio();
    var url = "http://192.168.33.69/API/delete_task_kanban.php";
    print(url);
  ...
  void addColumn(String title) async {
    ...
    final dio = Dio();
    var url = 'http://192.168.33.69/API/add_column_kanban.php'; //   print(url);
  ...
  void addTask(String title, int column) async {
    ...
    final dio = Dio();
    var url = "http://192.168.33.69/API/add_task_kanban.php";
  ...
  void dragHandler(KData data, int index) async {
    ...
    final dio = Dio();
    var url = "http://192.168.33.69/API/drag_drop_kanban.php";
